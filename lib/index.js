...
let generateCriticalCss = (() => {
  var _ref = _asyncToGenerator(function* (options, ast, { debuglog, stdOut, stdErr, START_TIME }) {
  ...
  return function generateCriticalCss(_x, _x2, _x3) {
...
function generateAstFromCssFile(options, { debuglog, stdOut, stdErr, START_TIME }) {
