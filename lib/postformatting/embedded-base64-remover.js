...
var _isTooLongBase64Encoded = function _isTooLongBase64Encoded(declaration, maxEmbeddedBase64Length) {
  return BASE64_ENCODE_PATTERN.test(declaration.value) && declaration.value.length > maxEmbeddedBase64Length;
};

var _removeDataUrisFromRule = function _removeDataUrisFromRule(rule, maxEmbeddedBase64Length) {
...
var embeddedbase64Remover = function embeddedbase64Remover(css, maxEmbeddedBase64Length) {
